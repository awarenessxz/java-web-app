...
import { initAnnouncementsAction } from '../../announcement/redux/announcement-action';
...
export const initBaseApplicationAction = (): RootThunkResult<void> => (dispatch, getState): void => {
    // fetch user details
